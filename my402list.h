...
struct object{
    ...
    char* lambda;
    char* mu;
    char* intervaltime_pack;
    char* time_server;
    int m;
    int num_packet;
    // long int t_enter_msec;
    // long int t_enter_usec;
    // long int t_leave_msec;
    // long int t_leave_usec;
    struct timeval t_enter;
    struct timeval t_leave;
    struct timeval t_enterQ2;

    // long int t_enterQ2_msec;
    // long int t_enterQ2_usec;
...
typedef struct tagMy402List {
    ...
    int  (*Append)(struct tagMy402List *, struct object*);
    int  (*Prepend)(struct tagMy402List *, struct object*);
...
extern int  My402ListAppend(My402List*, struct object*);
extern int  My402ListPrepend(My402List*, struct object*);
